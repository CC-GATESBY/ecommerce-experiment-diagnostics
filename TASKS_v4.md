...
**本轮更新（2026-09-18）：T3.4 done（历史基准＋条件式实验设计；未上线，本人解释未代验）。唯一REES46事实一次受控加载，历史合格7,856人、购买255人，p_hist=3.2459%；九个样本量与九个成本情景独立核对，业务准备条件明确。T3.3/T4/T5未执行，G0/G1不自动勾选。**
