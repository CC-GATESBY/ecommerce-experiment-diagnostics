...
**本轮更新（2026-09-18）：T3.2 done（工程验收，本人解释未代验）。corrected Criteo一次Spark全量总体聚合、18项测试及独立公式复核通过；conversion绝对增加11.519 bp，相对提升59.45%，每万人约多11.52个结果，仅适用于公开基准样本。T3.1 membership封存不变；T3.3/T3.4未执行，G0/G1不自动勾选。**
