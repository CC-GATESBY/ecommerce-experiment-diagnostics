...
**当前更新（2026-09-22）：TARGET-01与T3.3有限f0/f1描述分层done（train/valid开发评价，本人解释未代验）。30%同人数下简单定向相对随机有正向线索；基础响应与增量排序实际名单相同，尚无额外复杂度依据。test仅经历必要物理字节/身份对齐，未用于本轮特征/标签分析；E1/E2/G2和本人解释项不提前通过。**
