...
**本轮更新（2026-09-17）：T2.2 done（工程验收，本人解释未代验）。closeout按新授权一次聚合14个category_l1桶的月去重users/buyers，保留用户日；逐桶事件/购买/金额与历史精确对账。原金额排名、三条观察、八张图与旧真实数据不变。T2.3、T4.1–T4.4仍not_started，Criteo/T0.4及全项目G0/G1保持原状态。**
