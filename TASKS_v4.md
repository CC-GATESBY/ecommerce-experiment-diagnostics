...
**本轮更新（2026-09-18）：T4.1–T4.4 done（工程验收，本人解释未代验）。31行日指标与6,879行维度汇总形成10月25日唯一候选案例，检测中位数差−12.4945%，同组均值差−15.3279%；主要表现为M下降及electronics金额差，具体原因待定向SKU/构成取证。未执行T4.5/T5或策略上线，总门槛不自动勾选。**
