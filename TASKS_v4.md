...
**本轮更新（2026-09-17）：T1.3 统一指标层达到 done（工程验收，本人解释未代验）。仅经 FactReader 读取 month-v101-01，四层分别151,121/322,660/31/6,879行；主键、31天基线、维度守恒和写后重读通过。Criteo/T0.4、T1.4–T1.5、总G0/G1保持未完成。** 勾选只表示已检查的对应产物，本人独立解释项保留未勾选。
