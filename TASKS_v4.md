...
**本轮更新（2026-09-17）：T1.2 重复候选与会话核验达到 done（工程验收，本人解释未代验）。仅经 FactReader 读取 month-v101-01，主事实保留不变；892个重复候选组、1,433条超额记录，>5000会话为0。三场景及关联守恒已核验。Criteo/T0.4、T1.3–T1.5、总G0/G1保持未完成。** 勾选只表示已检查的对应产物，不表示后续代码或分析已运行。本人独立解释项保留未勾选，未替用户声明通过。
