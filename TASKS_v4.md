...
**当前更新（2026-09-23）：POWER-01 done（固定队列、未调整购买率功效模拟；本人解释未代验）。9档×300全部可计算；零效应双侧12/300，S1参考283/300，完整区间与失败分母保留。T5.7仅raw先行子项完成，整体in_progress；T5.6/CUPED和raw/CUPED比较未执行，T7.3/G2仍待本人解释。**
