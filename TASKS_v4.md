...
**本轮更新（2026-09-17）：T2.1 done（工程验收，本人解释未代验）。只读month-v101-01；31天行为覆盖及24小时顺序漏斗通过人工与真实核验。1,382,516条路径中正式1,341,998条，右端观察不足40,426条，同秒不确定92条。T2.2/T2.3、Criteo/T0.4与全项目G0/G1保持未完成。**
