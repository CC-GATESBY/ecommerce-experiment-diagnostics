...
**本轮更新（2026-09-17）：T1.1 日期质量规则、受控读取与人工跨月追加已通过，达到 done（工程验收，本人解释未代验）。唯一真实下游为 month-v101-01；未重新解析真实数据。Criteo 来源验收后移未取消，整个 T0.4 与 G0 未完成，T1.2–T1.5 和 G1 保持未完成。** 勾选只表示已检查的对应产物，不表示后续代码或分析已运行。本人独立解释项保留未勾选，未替用户声明通过。
