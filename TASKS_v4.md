...
**本轮更新（2026-09-17）：T1.5 done（10月首版范围冻结；本人解释未代验）。唯一绑定month-v101-01 / metrics-month-01 / crosscheck-month-01；31天描述性用途，24小时漏斗起始日为1–30日，历史min3有10天、full4有3天；仅冻结实验窗口。双月及更多用户未执行，不属本首版完成条件；T2.1/T4/T5未开始，Criteo/T0.4及全项目G0/G1保持未完成。**
...
本轮门槛核对：G0的T0.1–T0.3与REES46来源已验收，Criteo/T0.4仍待完成。G1要求的T1.1–T1.4证据在REES46分数据线已满足；这不代表项目其他数据线也已通过，全项目G0/G1不自动勾选。T1.5只完成十月首版范围冻结，本人解释未代验。
